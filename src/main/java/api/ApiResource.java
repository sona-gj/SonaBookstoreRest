...
public class ApiResource {
    ...
    public Category categoryByName(@PathParam("category-name") String name,
        ...
        try {
            ...
            if (result == null) {
                throw new ApiException(String.format("No such category is: %s", name));
            }
            return result;
        } catch (Exception e) {
            throw new ApiException(String.format("Category lookup by category-id %d failed", name), e);
        }
    }
    ...
    public List<Book> booksByCategoryName(@PathParam("category-name") String name,
        ...
        try {
            ...
            throw new ApiException(String.format("Books lookup by category-id %s failed", name), e);
        }
    }
